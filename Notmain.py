...
# def get_historical_klines(client):
...
#     historical_data = get_historical_klines(client)
...
#     # create bucket
#     bucket = s3.create_bucket(Bucket='binance_2024_data')
#     file_name = 'history_data.csv'

#     # upload file using upload file
#     s3.upload_file(
#         Filename=csv_buffer,
#         Bucket=bucket,
#         Key=file_name,
