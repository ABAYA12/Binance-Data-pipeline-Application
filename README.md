...
## Project Structure
- **data_ingestion.py**: Script for scraping football data from WhoScored.com.
- **data_modeling.py**: Script for cleaning, transforming, and modeling the football data.
